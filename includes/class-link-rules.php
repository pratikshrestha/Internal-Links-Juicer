...
class OILM_Link_Rules {
	...
	private function render_list() {
		...
		<div class="wrap">
			...
			<a href="?page=outpace-internal-link-manager&action=new" class="page-title-action">Add New</a>
	...
	public function save_rule() {
		...
		wp_redirect( admin_url( 'admin.php?page=outpace-internal-link-manager&message=saved' ) );
		exit;
	}
	...
	public function delete_rule() {
		...
		wp_redirect( admin_url( 'admin.php?page=outpace-internal-link-manager&message=deleted' ) );
		exit;
	}
}
